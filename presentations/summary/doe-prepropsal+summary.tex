...
\begin{abstract}
  \footnotesize{Distributed Exascale Computing is an important
    complementary and synergistic pathway to deliver science at the
    ...
    when to distribute? We propose to research, design and prototype
...
processing exabytes of data which are often distributed, as well as
...
model of an abstract simplified distributed application (A*), will
...
(W*) used to generate this workload from well-defined tasks will be
...
distributed compute, data and computational resources. In summary, we
